...
class Car:
    def __init__(self, color, marka, kuzov, transmission, speed = 0):
        self.color = color
        self.marka = marka
        self.kuzov = kuzov
        self.speed = speed
...
truck = Car("Blue", "MAZ", "truck", "automatic")
print(car.marka, car.color, car.kuzov, car.transmission, "\n")
...
print()
sleep(1)
print("\n", truck.marka, truck.color, truck.kuzov, truck.transmission, "\n")
